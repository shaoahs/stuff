...
export async function init (conf) {
  ...
  let config = {
    ...
    checkName: 'Game.{%= Group %}.{%= Name %}.CheckAction',
    fields: [
      {
        name: 'data',  // 需要解碼的欄位名稱
        rootName: 'Game.{%= Group %}.{%= Name %}',  // package name
      ...
      {
        name: 'info',  // 需要解碼的欄位名稱
        rootName: 'Game.{%= Group %}.{%= Name %}.Info',  // package name
        typeName: 'ActionType',   // 命令清單代碼
        cmdList: [  // 命令清單
          'BaseResponse'
        ]
      },
      {
        ...
        rootName: 'Game.{%= Group %}.{%= Name %}.Jackpot',  // package name
        typeName: 'ActionType',   // 命令清單代碼
        cmdList: [  // 命令清單
          'BaseResponse'
        ]
      },
      {
        ...
        rootName: 'Game.{%= Group %}.{%= Name %}.Setting',  // package name
        typeName: 'ActionType',   // 命令清單代碼
        cmdList: [  // 命令清單
          'BaseResponse'
        ]
